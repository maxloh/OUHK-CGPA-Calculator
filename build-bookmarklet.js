...
2. Replace ' with \' in the resulting string
3. Remove all occurance of \n in the resulting string of (2)
4. Put the resulting string of (3) into the "script" variable of this script
5. Run this script
*/
...
console.log(encodeURI('javascript:(function(){' + script + '})();'));